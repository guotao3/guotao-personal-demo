...
public class AliyunOSSUtil {
	...
	private static final String DOMAIN_NAME = "http://motian-oss.oss-cn-shenzhen.aliyuncs.com";
...
//		createFileDir("headpic");
		...
		//upload file
		String uuid = "";
		File file = new File("E:/hx/project/motian/dafengmall.apk");
		try {
			uploadFile("dafengmall.apk", file);
			System.out.println("http://motian-oss.oss-cn-shenzhen.aliyuncs.com/" + "dafengmall.apk");
